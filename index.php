    ...
    <head profile="http://gmpg.org/xfn/11">
        ...
        <title>
            ...
            if (is_home()) {
                ...
                _e('Archive for ', 'thoughtplifier');
                wp_title('');
            } elseif (is_author()) {
                wp_title(__(' | Post written by ', 'thoughtplifier'));
            } elseif (is_search()) {
                echo __('Search results for "', 'thoughtplifier') . $s . '"';
            } elseif (is_404()) {
                _e('Four-oh-Four', 'thoughtplifier');
            } else {
                _e('Are You Lost?', 'thoughtplifier');
            }
            ?>
        </title>
